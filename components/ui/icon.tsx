...
type IconName =
  ...
  | "crown" | "trending" | "download" | "file" | "chart";
...
export function Icon({ name, size = 20, color = "currentColor", strokeWidth = 2, className }: IconProps) {
  ...
  const paths: Record<IconName, React.ReactNode> = {
    ...
    crown: <g><path d="M3 8l4 4 5-7 5 7 4-4-2 11H5L3 8z" /><path d="M5 19h14" /></g>,
    trending: <g><path d="M3 17l6-6 4 4 8-8" /><path d="M14 7h7v7" /></g>,
    download: <g><path d="M12 4v12M6 12l6 6 6-6" /><path d="M4 20h16" /></g>,
    file: <g><path d="M14 3H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2V9z" /><path d="M14 3v6h6" /></g>,
